...
public class MainActivityLow extends YouTubeBaseActivity implements YouTubePlayer.OnInitializedListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_mainlow);

        youTubeView = findViewById(R.id.youtube_view_low);
